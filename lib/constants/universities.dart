const List<String> uzbekUniversities = [
  // Andijan
  ...
  "Moscow State University in Tashkent (M.V. Lomonosov)",
  ...
  "Tashkent University of Information Technologies (TATU)",
